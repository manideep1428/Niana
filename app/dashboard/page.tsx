        ...
        <div className="max-w-6xl mx-auto px-6 py-8 pt-28">
          ...
          <div className="flex gap-2 mb-6">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${activeTab === "favourites"
                ? "bg-black/10 dark:bg-white/10 text-black dark:text-white border border-black/20 dark:border-white/20"
                : "text-black/60 dark:text-white/60 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5"
                }`}
            >
          ...
          {projects === undefined ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <Button
                onClick={() => router.push("/")}
                className="bg-[#ffdec1] text-orange-900 hover:bg-[#ffd0a8] border border-orange-200"
              >
                ...
                >
                  ...
                  <div className="aspect-square bg-secondary dark:bg-white/5 flex items-center justify-center relative overflow-hidden">
                    ...
                    <button
                      ...
                      className={`absolute top-3 right-3 p-2 rounded-lg bg-card/80 dark:bg-black/40 backdrop-blur-sm hover:bg-card dark:hover:bg-black/60 transition-all ${project.is_favorite

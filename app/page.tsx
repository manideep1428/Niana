    ...
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[60%]">
          <div className="absolute inset-0 bg-gradient-to-t from-orange-600/40 via-pink-600/20 to-transparent" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-[400px] bg-gradient-to-t from-orange-500/50 via-pink-500/30 to-transparent blur-3xl" />
        ...
        <div className="flex flex-col items-center justify-center h-screen px-4">
          ...
          <div className="text-center mb-6 space-y-4 max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <span className="text-xs text-white/80">AI-Powered Design Studio</span>
            </div>
            
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
              <span className="text-white">Design anything with </span>

...
export default function PricingPage() {
  ...
  return (
    <AppLayout>
                ...
                (planId, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* Card */}
                      <div
                        className={`relative h-full rounded-2xl overflow-hidden transition-all duration-300 ${isCurrentPlan
                      ...
                      >
                        <div className="p-6 flex flex-col h-full">
                          ...
                          <button
                            ...
                            className={`w-full py-3 px-6 rounded-xl font-medium transition-all duration-300 mb-6 ${isCurrentPlan && !isEnterprise
                          ...
                          <ul className="space-y-2.5 flex-grow">
                            {(isEnterprise
                              ...
                              >
                                <Check
                                  className={`w-4 h-4 mt-0.5 flex-shrink-0 ${plan.popular
      ...
      {/* Success Animation Modal - kept inside AppLayout */}
      <AnimatePresence>
        {
          showSuccess && (
            <motion.div
